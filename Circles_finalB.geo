C// Gmsh project created on Tue Nov  3 23:06:23 2020
...
r1b = 5;
mesh = 1.50; //mesh size inside circles
...
Translate {L[0], L[1], 0} {Surface{5};} 
Translate {L[2], L[3], 0} {Duplicata{Surface{5};}}
Translate {L[4], L[5], 0} {Duplicata{Surface{5};}}
Translate {L[6], L[7], 0} {Duplicata{Surface{5};}}
Translate {L[8], L[9], 0} {Duplicata{Surface{5};}}

Plane Surface(1) = {1,5,6,7,8,9};
Physical Surface(1) = {1};
